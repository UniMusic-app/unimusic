...
import { idCardOutline as metadataServicesIcon } from "ionicons/icons";

import AppPage from "@/components/AppPage.vue";
import { useMetadataServices } from "@/stores/metadata-services";
import { computed, ref } from "vue";

const services = useMetadataServices();
...
<template>
	...
	>
		...
		<ion-content id="metadata-services-page-content" class="ion-padding">
			<header>
				<ion-icon :icon="metadataServicesIcon" color="primary" />
				<ion-header collapse="condense">
					<ion-toolbar>
						<ion-title class="ion-text-nowrap" size="large">Metadata</ion-title>
					</ion-toolbar>
				</ion-header>
				<ion-note>
					Metadata Services can retrieve information about your songs in case its not embedded in them.
				</ion-note>
			</header>
			...
			<ion-note color="medium" class="ion-padding">
				Order of Metadata Services determines which ones will be fetched first.
			</ion-note>
		</ion-content>
	</AppPage>
</template>
...
<style scoped>
#metadata-services-page-content {
	& > header {
		text-align: center;
		margin-inline: auto;
		margin-bottom: 16px;
